    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      //  String userName = (String) session.getAttribute("username");
        ...
        // constructs the directory path to store upload file
         String uploadPath = getServletContext().getRealPath("foodimages");
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/onlinefoodorder","root","password");
                    String sql = "insert into fooddetails(name,price,filename) values('"+hm.get("name")+"','"+hm.get("price")+"','"+hm.get("filename")+"')";
